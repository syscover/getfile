	...
	var GetFile = {
		options: {
			...
			crop: {
                ...
                backgroundColor:        '#ffffff',                                       // Set background color on smaller crop image that final image
                strict:                 false                                        // allows a larger crop than the original image
		...
		crop: function(imageUrl)
		{
            ...
            $(this.items.image).cropper({
                ...
                preview:        '.img-preview',
                strict:         this.options.crop.strict,
                built: function () {
		...
		executeCrop: function()
		{
            ...
            $.ajax({
                ...
                data: {
                    ...
                    backgroundColor:    this.options.crop.backgroundColor,
